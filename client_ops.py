"""Dashboard, privacy masking, and access helpers for ConX Client."""
    ...
    *,
    ...
    if api_error:
        flags.append(
            {
                "level": "critical",
                "title": "ConX API connection failed",
                "detail": api_error,
        ...
        flags.append(
            {
                "level": "critical",
                "title": "Cannot load ConX account",
    ...
    if account:
        if account.get("expired"):
            flags.append(
                {
                    "level": "critical",
                    "title": "ConX account expired",
                    "detail": "Renew billing on the main ConX server.",
                    "href": url_for("settings"),
                }
            )
                ...
                flags.append(
                    {
                        ...
                        "detail": f"{monthly_used} of {monthly_limit} searches used on the shared ConX account.",
            ...
            flags.append(
                {
                    ...
                    "detail": "Team searches may fail until credits are added on ConX.",
                    "href": url_for("dashboard"),
                }
            )
        elif credits <= 5:
            flags.append(
                {
                    ...
                    "detail": "Consider topping up the ConX wallet before the team is blocked.",
                    "href": url_for("dashboard"),
                }
            )
