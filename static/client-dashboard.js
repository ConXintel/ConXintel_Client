          ...
          datasets: [
            {
              ...
              data: cpuSeries,
              borderColor: "#ed2024",
              backgroundColor: "rgba(237, 32, 36, 0.12)",
              fill: true,
              tension: 0.25,
              pointRadius: 0,
              pointHoverRadius: 3,
          ...
          datasets: [
            {
              ...
              backgroundColor: ["rgba(237, 32, 36, 0.85)", "rgba(136, 136, 160, 0.45)"],
              borderWidth: 0,
            },
          ],
        },
          ...
          datasets: [
            {
              label: "Searches",
              data: C.day_counts || [],
              borderColor: "rgba(237, 32, 36, 0.9)",
              backgroundColor: "rgba(237, 32, 36, 0.15)",
              fill: true,
              tension: 0.25,
            },
          ],
