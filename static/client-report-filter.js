(function () {
  ...
  function syncReportContextToServer(filters) {
    ...
    var syncUrl = window.conxReportContextSyncUrl;
    ...
    return fetch(syncUrl, {
      ...
      headers: {
        ...
        "X-CSRF-Token": window.conxClientCsrfToken || "",
      },
      body: JSON.stringify({
  ...
  function applyFilters(root) {
    ...
    if (typeof window.conxWorkspaceRerender === "function") {
      window.conxWorkspaceRerender();
    }
  ...
  function hookPrintButton(root) {
    ...
    var timer = window.setInterval(function () {
      tries += 1;
      if (typeof window.conxWorkspaceRerender === "function" || tries > 40) {
